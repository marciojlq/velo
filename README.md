...
# Instalar CLI
yarn add supabase -D
# Na minha máquina, só está funcionando utilizando o NPX:
# npx add supabase -D
...
yarn supabase link --project-ref ehwwzqgqfjpgbnevwqwo
# Na minha máquina, só está funcionando utilizando o NPX:
# npx supabase link --project-ref ehwwzqgqfjpgbnevwqwo
